...
import impl.EstatisticasCampeonato;
...
public class Aplicacao {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // obter a implementação: (ponto extra -- abstrair para interface) - DONE!
        EstatisticasCampeonato resultados =
    ...
    private static void imprimirEstatisticas(EstatisticasCampeonato brasileirao) {
